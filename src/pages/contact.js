...
const IndexPage = () => (
  <Layout pageInfo={{ pageName: "index" }}>
    ...
    <Container className="text-center">
      ...
      <p className="text-left">I'm a security analyst that's been in the industry for a few years now. I'm by no way an expert but I'm trying to learn as much as I can about the field. I'm a bit of a tinkerer and try to experiment with as much as I can. The tutorials on this site are things that I have collated where I've had issues or learned new things. Most of the projects are things I thought would be useful, or fun, to myself and I've put them up here in case anyone else finds them useful.</p>
